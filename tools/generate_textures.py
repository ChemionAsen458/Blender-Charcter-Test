...
def build_shirt(size, meshes):
    ...
    bar_at((0.098, -0.098, 1.262), 0.150, 0.052, -34.0)
    bar_at((-0.098, -0.098, 1.262), 0.150, 0.052, 34.0)
    bar_at((0.062, -0.108, 0.968), 0.130, 0.048, 52.0)
    bar_at((-0.062, -0.108, 0.968), 0.130, 0.048, -52.0)
    bar_at((0.104, 0.092, 1.272), 0.140, 0.050, 34.0)
    bar_at((-0.104, 0.092, 1.272), 0.140, 0.050, -34.0)
    bar_at((0.108, 0.086, 1.014), 0.120, 0.046, -48.0)
    bar_at((-0.108, 0.086, 1.014), 0.120, 0.046, 48.0)
