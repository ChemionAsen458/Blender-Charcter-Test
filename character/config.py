...
ARM_PATH = [
    ...
    (0.184,  0.000, 1.288, 0.053),   # deltoid
    (0.194,  0.006, 1.216, 0.047),
    (0.200,  0.011, 1.140, 0.043),
    (0.205,  0.015, 1.062, 0.040),   # elbow, bowed backwards
    (0.209,  0.010, 0.984, 0.037),
    (0.213,  0.006, 0.922, 0.033),
...
LEG_PATH = [
    ...
    (0.091, -0.006, Z["thigh"], 0.074),
    (0.089, -0.009, 0.540, 0.065),
    (0.088, -0.013, Z["knee"], 0.062),  # knee, bowed forwards
    (0.087, -0.004, 0.380, 0.060),
    (0.086,  0.007, Z["calf"], 0.056),  # calf bulges backwards
    (0.085,  0.003, 0.190, 0.046),
    (0.085,  0.000, Z["ankle"], 0.037),  # ankle
]
KNEE_INDEX = 4
